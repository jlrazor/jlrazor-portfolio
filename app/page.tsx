...
export default function Portfolio() {
  ...
  const socialLinks = {
    ...
    mail:
      "https://mail.google.com/mail/?view=cm&fs=1&to=cotteallan30@gmail.com",
  };
  ...
  const projects = [
    ...
    },
    {
      ...
      type: "Affiche",
      category: "Affiches",
      image: "/lol_rsc_final_sans_les_point_1.png",
    },
    {
      title: "Arena",
      type: "Affiche",
      category: "Affiches",
      image: "/Nouveau_projet_22.png",
    },
    {
      title: "RLCS",
      type: "Affiche",
      category: "Affiches",
      image: "/rscrlcs_2_1.png",
    },
    {
      title: "COD",
      type: "Affiche",
      category: "Affiches",
      image: "/cod_ma_version_1.png",
    },
    {
      title: "Kami",
      type: "Affiche",
      category: "Affiches",
      image: "/kami_rzr_2.png",
    },
    {
      title: "Maillot",
      type: "Affiche",
    ...
    },
    {
      ...
      type: "3D",
      category: "3D",
      image: "/jlfennec5-1.png",
    },
    {
      title: "Workers 01",
      type: "3D",
      category: "3D",
      image: "/theworkersrendu2.png",
    },
    {
      title: "Workers 02",
      type: "3D",
      category: "3D",
      image: "/theworkersrendu3.png",
    },
    {
      title: "TodoBew 01",
      type: "3D",
      category: "3D",
      image: "/todobewrender1.png",
    },
    {
      title: "TodoBew 02",
      type: "3D",
      category: "3D",
      image: "/todobewrender3.png",
    },
    {
      title: "Fennec Front",
      type: "3D",
      category: "3D",
      image: "/fennecfront.png",
    },
    {
      title: "White Gold",
      type: "3D",
    ...
    },
    {
      ...
      type: "Cover",
      category: "Covers",
      image: "/nocapfreeze.png",
    },
    {
      title: "Big Fatrip",
      type: "Cover",
      category: "Covers",
      image: "/bigfatrip_2.png",
    },
    {
      title: "Sans Raccord",
      type: "Cover",
      category: "Covers",
      image: "/Nouveau_projet_13.png",
    },
    {
      title: "Raison",
      type: "Cover",
      category: "Covers",
      image: "/blicky_raison_ytb.png",
    },
    {
      title: "Zombie",
      type: "Cover",
    ...
    {
      title: "C'est pas sa faute",
      type: "Cover",
      category: "Covers",
      image: "/Nouveau_projet_32.png",
    },
    {
      title: "OSNR Mafia",
      type: "Cover",
      category: "Covers",
      image: "/Nouveau_projet_38.png",
    },
    {
      title: "Piano Part 2",
      type: "Cover",
      category: "Covers",
      image: "/Presentation_YouTube_Cover_ULM_1.png",
    },
    {
      title: "Glockboy",
      type: "Cover",
      category: "Covers",
      image: "/Presentation_YouTube_Cover_ULM_2.png",
    },
    {
      title: "Typography",
      type: "Cover",
      category: "Covers",
      image: "/Nouveau_projet_44.png",
    },
    {
      title: "Mon Del Snow",
      type: "Cover",
      category: "Covers",
      image: "/Cover_Mon_Del_Snow.png",
    },
  ];

  const categories = ["Tout", "Logos", "Affiches", "3D", "Covers"];
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#050505] text-white">
      ...
      <section
        id="home"
        className="mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-28"
      >
        <div className="w-full text-center">
          ...
          <h1 className="mx-auto max-w-5xl text-5xl font-black leading-tight md:text-7xl">
            Donner vie à vos{" "}
            <span className="text-red-500">idées</span>.
          </h1>
          ...
          <div className="mt-10 flex justify-center gap-4">
            <a
              href="#work"
              className="rounded-2xl bg-red-600 px-8 py-4 font-bold uppercase tracking-wider transition hover:bg-red-500"
            >
              Voir mes projets
            </a>
            ...
            <a
              href="#contact"
              className="rounded-2xl border border-white/10 px-8 py-4 font-bold uppercase tracking-wider transition hover:border-red-500"
            >
              Contact
            </a>
          </div>
      ...
      <section
        id="services"
        className="relative z-50 mx-auto max-w-7xl px-6 py-28"
      >
        <div className="mb-14">
      ...
      <section
        id="about"
        className="mx-auto grid max-w-7xl gap-12 px-6 py-28 md:grid-cols-2"
      >
        <div>
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.35em] text-red-500">
            À propos
          ...
          <p className="mt-7 text-lg leading-8 text-white/60">
            Direction artistique, identité visuelle, covers, affiches esport et
            créations 3D pour rendre chaque projet unique.
          </p>
        </div>
